...
void	set_target_symbols_32(void *file_map, Elf32_Shdr *sections, Elf32_Shdr *target_section, Elf32_Shdr *strtab_section, t_symbol_entry *symbols, size_t *pos_symbols)
{
...
void	set_symbols_32(void *file_map, Elf32_Shdr *sections, t_symbol_entry *symbols, Elf32_Half sections_count)
{
	...
	for (int i = 0; i < sections_count; i++)
	{
		if ((sections[i].sh_type == SHT_SYMTAB))
		{
			...
			set_target_symbols_32(file_map, sections, target_section, strtab_section, symbols, &pos_symbols);
		}
	}
