...
bool	is_unvalid_symbol_64(Elf64_Sym sym, size_t current_index, Elf64_Sym *symtab, const char *strtab, size_t total_symbols, Elf64_Shdr *sections);
bool	is_unvalid_symbol_32(Elf32_Sym sym, size_t current_index, Elf32_Sym *symtab, const char *strtab, size_t total_symbols, Elf32_Shdr *sections);
