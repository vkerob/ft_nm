...
static bool	cleanup_and_report(const char *file, int fd, void **file_map, size_t map_size)
{
...
static bool	check_header(void **file_map, struct stat file_stat, const char *file, int fd)
{
